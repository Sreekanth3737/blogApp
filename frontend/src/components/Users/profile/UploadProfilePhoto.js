...
import { uploadProfilePhotoAction } from "../../../redux/slices/users/usersSlice";
...
export default function UploadProfilePhoto() {
  ...
  const{profilePhoto,appErr,serverErr,loading,userAuth}=users
  if(profilePhoto) return <Navigate to= {`/profile/${userAuth?._id}`}/>
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-blue-600 animate-bounce">
