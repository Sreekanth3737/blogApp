...
import { updateUserAction,fetchUserDetailsAction } from "../../../redux/slices/users/usersSlice";
  ...
  return (
    <div className=" bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h3 className=" text-center text-2xl font-extrabold text-gray-500 animate-bounce">
         Hei <span className="text-white bg-indigo-500"> {userDetails?.firstName} {userDetails?.lastName}</span> Do you want to update your profile?
        </h3>
        {/* ERR */}
