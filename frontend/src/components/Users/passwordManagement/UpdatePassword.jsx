...
import { updatePasswordAction } from "../../../redux/slices/users/usersSlice";
  ...
  return (
    <div className="min-h-screen bg-zinc-100  flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-blue-500 animate-bounce">
            ...
            <div>
              ...
              {loading ? (
                <button
                  disabled
                  type="submit"
                  className="inline-flex bg-indigo-700 justify-center w-full px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-200  hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                >
